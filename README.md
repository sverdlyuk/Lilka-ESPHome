...
Ця конфігурація забезпечує наступний функціонал:
...
1. Завантажте [.bin файл](https://github.com/sverdlyuk/Lilka-ESPHome/releases), або скомпілюйте його самостійно з файлу .yaml
2. Прошийте Лілку по кабелю за допомогою [ESPHome Web](https://web.esphome.io)
3. Знайдіть та підключіться до Wi-Fi мережі Лілки, щоб встановити свою
